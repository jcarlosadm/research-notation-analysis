...
public class GitProject {
    ...
    /**
     * Constructor
     * @param url remote url of git project
     */
     ...
     * @param projectFolder path of main project folder 
     */
    ...
    /**
     * set path of current commit temporary folder. GitManager of current commit will be set too.
    ...
    /**
     * set path of previous commit temporary folder. GitManager of previous commit will be set too.
